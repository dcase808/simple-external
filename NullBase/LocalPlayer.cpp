...
int LocalPlayer::getObserveMode()
{
	return rpm<int>(LocalPlayer::getLocalPlayer() + netvars::m_iObserverMode);
}

void LocalPlayer::setObserveMode(int mode)
{
	wpm<int>(mode, LocalPlayer::getLocalPlayer() + netvars::m_iObserverMode);
}
