...
namespace LocalPlayer
{
	...
	extern int              getObserveMode();												//Get the m_iObserveMode

																							//Void functions 
	extern void				forceJump(int waitTime = 29);									//Force the local player to jump
	...
	extern void				setObserveMode(int mode);										//Set the observe mode
